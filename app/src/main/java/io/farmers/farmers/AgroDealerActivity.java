...
public class AgroDealerActivity extends AppCompatActivity {
    EditText edtNames, edtPhone, edtLocation, edtSpeciality;
    ...
    public void register(View view) {
        ...
        String profession = edtSpeciality.getText().toString().trim();
        validate(names, edtNames);
        validate(phone, edtPhone);
        validate(location, edtLocation);
        validate(profession, edtSpeciality);
        farmersRef = FirebaseDatabase.getInstance().getReference().child("dealers/" + phone + "/basic");
